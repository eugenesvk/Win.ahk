...
setChar🠿() { ; hold key to select a symbol from a popup menu
  ...
  hkChar🠿(hk_dirty) {
    ...
    Switch hk, 0 {
      ...
      case  a⃣  :	char→sym(hk,Dia['a'],unset,'a',false) ;InStr(lbl🖰hide,'a'))
      case ⇧a  : 	char→sym(hk,Dia['A'],unset,'a',false) ;InStr(lbl🖰hide,'a') & is∗)
      case  c⃣  :	char→sym(hk,Dia['c'],unset,'a',false) ;InStr(lbl🖰hide,'c'))
      case ⇧c  : 	char→sym(hk,Dia['C'],unset,'a',false) ;InStr(lbl🖰hide,'c') & is∗)
      case  e⃣  :	char→sym(hk,Dia['e'],unset,'a',false) ;InStr(lbl🖰hide,'e'))
      case ⇧e  : 	char→sym(hk,Dia['E'],unset,'a',false) ;InStr(lbl🖰hide,'e') & is∗)
      case  i⃣  :	char→sym(hk,Dia['i'],unset,'a',false) ;InStr(lbl🖰hide,'i'))
      case ⇧i  : 	char→sym(hk,Dia['I'],unset,'a',false) ;InStr(lbl🖰hide,'i') & is∗)
      case  l⃣  :	char→sym(hk,Dia['l'],unset,'a',false) ;InStr(lbl🖰hide,'l'))
      case ⇧l  : 	char→sym(hk,Dia['L'],unset,'a',false) ;InStr(lbl🖰hide,'l') & is∗)
      case  n⃣  :	char→sym(hk,Dia['n'],unset,'a',false) ;InStr(lbl🖰hide,'n'))
      case ⇧n  : 	char→sym(hk,Dia['N'],unset,'a',false) ;InStr(lbl🖰hide,'n') & is∗)
      case  o⃣  :	char→sym(hk,Dia['o'],unset,'a',false) ;InStr(lbl🖰hide,'o'))
      case ⇧o  : 	char→sym(hk,Dia['O'],unset,'a',false) ;InStr(lbl🖰hide,'o') & is∗)
      case  s⃣  :	char→sym(hk,Dia['s'],unset,'a',false) ;InStr(lbl🖰hide,'s'))
      case ⇧s  : 	char→sym(hk,Dia['S'],unset,'a',false) ;InStr(lbl🖰hide,'s') & is∗)
      case  u⃣  :	char→sym(hk,Dia['u'],unset,'a',false) ;InStr(lbl🖰hide,'u'))
      case ⇧u  : 	char→sym(hk,Dia['U'],unset,'a',false) ;InStr(lbl🖰hide,'u') & is∗)
      case  y⃣  :	char→sym(hk,Dia['y'],unset,'a',false) ;InStr(lbl🖰hide,'y'))
      case ⇧y  : 	char→sym(hk,Dia['Y'],unset,'a',false) ;InStr(lbl🖰hide,'y') & is∗)
      case  z⃣  :	char→sym(hk,Dia['z'],unset,'a',false) ;InStr(lbl🖰hide,'z'))
      case ⇧z  : 	char→sym(hk,Dia['Z'],unset,'a',false) ;InStr(lbl🖰hide,'z') & is∗)
