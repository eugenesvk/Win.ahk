...
class localeNLS_SubGroups { ; define the "LOCALE_..." constants
  ...
  , RRETURN := Map(
    "LOCALE_RETURN_GENITIVE_NAMES"	,0x10000000,	; Win7+: Retrieve the genitive names of months, which are the names used when the month names are combined with other items. eg, in Ukrainian the equivalent of January is written "Січень" when the month is named alone. However, when the month name is used in combination, eg, in a date such as January 5th, 2003, the genitive form of the name is used. For the Ukrainian example, the genitive month name is displayed as "5 січня 2003". The list of genitive month names begins with January and is semicolon-delimited. If there is no 13th month, use a semicolon in its place at the end of the list. Note: Genitive month names do not exist in all languages.
  ...
  , SABBREV := Map(
    ...
    ; Native abbreviated name  	            	for …	. Max number of chars allowed for this string is 80, including a terminating null character.
    "LOCALE_SABBREVDAYNAME1"   	,0x00000031,	;   … Monday
    "LOCALE_SABBREVDAYNAME2"   	,0x00000032,	;   … Tuesday
    "LOCALE_SABBREVDAYNAME3"   	,0x00000033,	;   … Wednesday
    "LOCALE_SABBREVDAYNAME4"   	,0x00000034,	;   … Thursday
    "LOCALE_SABBREVDAYNAME5"   	,0x00000035,	;   … Friday
    "LOCALE_SABBREVDAYNAME6"   	,0x00000036,	;   … Saturday
    "LOCALE_SABBREVDAYNAME7"   	,0x00000037,	;   … Sunday
    "LOCALE_SABBREVMONTHNAME1" 	,0x00000044,	;   … January
    "LOCALE_SABBREVMONTHNAME10"	,0x0000004D,	;   … October
    "LOCALE_SABBREVMONTHNAME11"	,0x0000004E,	;   … November
    "LOCALE_SABBREVMONTHNAME12"	,0x0000004F,	;   … December
    "LOCALE_SABBREVMONTHNAME13"	,0x0000100F,	;   … a 13th month, if it exists
    "LOCALE_SABBREVMONTHNAME2" 	,0x00000045,	;   … February
    "LOCALE_SABBREVMONTHNAME3" 	,0x00000046,	;   … March
    "LOCALE_SABBREVMONTHNAME4" 	,0x00000047,	;   … April
    "LOCALE_SABBREVMONTHNAME5" 	,0x00000048,	;   … May
    "LOCALE_SABBREVMONTHNAME6" 	,0x00000049,	;   … June
    "LOCALE_SABBREVMONTHNAME7" 	,0x0000004A,	;   … July
    "LOCALE_SABBREVMONTHNAME8" 	,0x0000004B,	;   … August
    "LOCALE_SABBREVMONTHNAME9" 	,0x0000004C,	;   … September
    "LOCALE_SABBREVLANGNAME"   	,0x00000003,	; Abbreviated name of the language. In most cases, the name is created by taking the two-letter language abbreviation from ISO Standard 639 and adding a third letter, as appropriate, to indicate the sublanguage. eg, the abbreviated name for the language corresponding to the English (United States) locale is ENU.
  )
  , SDAYNAME := Map( ; Native long name for … . Max number of chars allowed for this string is 80, including a terminating null character.
    "LOCALE_SDAYNAME1"	,0x0000002A,	; … Monday
    "LOCALE_SDAYNAME2"	,0x0000002B,	; … Tuesday
    "LOCALE_SDAYNAME3"	,0x0000002C,	; … Wednesday
    "LOCALE_SDAYNAME4"	,0x0000002D,	; … Thursday
    "LOCALE_SDAYNAME5"	,0x0000002E,	; … Friday
    "LOCALE_SDAYNAME6"	,0x0000002F,	; … Saturday
    "LOCALE_SDAYNAME7"	,0x00000030,	; … Sunday
  )
  , SENG := Map(
    "LOCALE_SENGLISHCOUNTRYNAME" 	,0x00001002,	; Win7+: English name of the country/region, eg, Germany for Deutschland. This name is always restricted to characters that can be mapped into the ASCII 127-character subset.
    "LOCALE_SENGLISHDISPLAYNAME" 	,0x00000072,	; Win7+: Display name of the locale in English. Usually the display name consists of the language and the country/region, eg, German (Germany) for Deutsch (Deutschland).
    "LOCALE_SENGLISHLANGUAGENAME"	,0x00001001,	; Win7+: English name of the language in English, eg, German for Deutsch, from International ISO Standard 639. This name is always restricted to characters that can be mapped into the ASCII 127-character subset.
  )
  , SENGLISH := Map(
    "LOCALE_SENGCOUNTRY" 	,0x00001002,	; Deprecated for Win7+. Full English name of the country/region. See LOCALE_SENGLISHCOUNTRYNAME.
    "LOCALE_SENGCURRNAME"	,0x00001007,	; WinMe/98, Win2000: The full English name of the currency associated with the locale. There is no limit on the number of characters allowed for this string.
    "LOCALE_SENGLANGUAGE"	,0x00001001,	; Deprecated for Win7+. Full English name of the language from ISO Standard 639. See LOCALE_SENGLISHLANGUAGENAME.
  )
  , SISO := Map(
    "LOCALE_SISO3166CTRYNAME" 	,0x0000005A,	; WinMe/98, WinNT4.0: Country/region name, based on ISO Standard 3166, such as "US" for the United States. This can also return a number, such as "029" for Caribbean. The maximum number of characters allowed for this string is nine, including a terminating null character.
    "LOCALE_SISO3166CTRYNAME2"	,0x00000068,	; WinVista+: Three-letter ISO region name (ISO 3166 three-letter code for the country/region), such as "USA" for the United States. This can also return a number, such as "029" for Caribbean. The maximum number of characters allowed for this string is nine, including a terminating null character.
    "LOCALE_SISO639LANGNAME"  	,0x00000059,	; WinMe/98, WinNT4.0: The abbreviated name of the language based entirely on the ISO Standard 639 values, in lowercase form, such as "en" for English. This can be a 3-letter code for languages that don't have a 2-letter code, such as "haw" for Hawaiian. The maximum number of characters allowed for this string is nine, including a terminating null character.
    "LOCALE_SISO639LANGNAME2" 	,0x00000067,	; WinVista+: Three-letter ISO language name, in lowercase form (ISO 639-2 three-letter code for the language), such as "eng" for English. The maximum number of characters allowed for this string is nine, including a terminating null character.
  )
  , SLOCALIZED := Map(
    "LOCALE_SLOCALIZEDCOUNTRYNAME" 	,0x00000006,	; Win7+: Full localized name of the country/region, eg, Deutschland for Germany. The maximum number of characters allowed for this string is 80, including a terminating null character. Since this name is based on the localization of the product, it changes for each localized version.
    "LOCALE_SLOCALIZEDDISPLAYNAME" 	,0x00000002,	; Win7+: Full localized name of the locale for the user interface language, eg, Deutsch (Deutschland) for German (Germany)" There is no limit on the number of characters allowed for this string. Since this name is based on the localization of the product, it changes for each localized version.
    "LOCALE_SLOCALIZEDLANGUAGENAME"	,0x0000006f,	; Windows Vista: Full localized primary name of the user interface language included in a localized display name, eg, Deutsch representing German. Since this name is based on the localization of the product, it changes for each localized version.
  )
  , SMON := Map(
    "LOCALE_SMONDECIMALSEP" 	,0x00000016,	; Character(s) used as the monetary decimal separator. The maximum number of characters allowed for this string is four, including a terminating null character. eg, if a monetary amount is displayed as "$3.40", just as "three dollars and forty cents" is displayed in the United States, then the monetary decimal separator is ".".
    "LOCALE_SMONGROUPING"   	,0x00000018,	; Sizes for each group of monetary digits to the left of the decimal. The maximum number of characters allowed for this string is ten, including a terminating null character. An explicit size is needed for each group, and sizes are separated by semicolons. If the last value is 0, the preceding value is repeated. eg, to group thousands, specify 3;0. Indic languages group the first thousand and then group by hundreds. For example 12,34,56,789 is represented by 3;2;0.
  ...
  , SMONTHNAME := Map( ; Native long name for … . Max number of chars allowed for this string is 80, including a terminating null character. Note: Calling the GetLocaleInfo or GetLocaleInfoEx function with a LOCALE_SMONTHNAME* constant returns the standalone, or nominative, form of the month name. To get the genitive form of the month name, the application calls GetDateFormat or GetDateFormatEx with a date picture of ddMMMM and removes the two digits from the beginning of the retrieved string.
    "LOCALE_SMONTHNAME1" 	,0x00000038,	; … January
    "LOCALE_SMONTHNAME2" 	,0x00000039,	; … February
    "LOCALE_SMONTHNAME3" 	,0x0000003A,	; … March
    "LOCALE_SMONTHNAME4" 	,0x0000003B,	; … April
    "LOCALE_SMONTHNAME5" 	,0x0000003C,	; … May
    "LOCALE_SMONTHNAME6" 	,0x0000003D,	; … June
    "LOCALE_SMONTHNAME7" 	,0x0000003E,	; … July
    "LOCALE_SMONTHNAME8" 	,0x0000003F,	; … August
    "LOCALE_SMONTHNAME9" 	,0x00000040,	; … September
    "LOCALE_SMONTHNAME10"	,0x00000041,	; … October
    "LOCALE_SMONTHNAME11"	,0x00000042,	; … November
    "LOCALE_SMONTHNAME12"	,0x00000043,	; … December
    "LOCALE_SMONTHNAME13"	,0x0000100E,	; … a 13th month, if it exists
  )
  , SNATIVE := Map(
    "LOCALE_SNATIVECOUNTRYNAME" 	,0x00000008,	; Win7+: Native name of the country/region, eg, España for Spain. The maximum number of characters allowed for this string is 80, including a terminating null character.
    "LOCALE_SNATIVECTRYNAME"    	,0x00000008,	; Deprecated for Win7+. Native name of the country/region. See LOCALE_SNATIVECOUNTRYNAME.
    "LOCALE_SNATIVECURRNAME"    	,0x00001008,	; WinMe/98, Win2000: The native name of the currency associated with the locale, in the native language of the locale. There is no limit on the number of characters allowed for this string.
    "LOCALE_SNATIVEDIGITS"      	,0x00000013,	; Native equivalents of ASCII 0 through 9. The maximum number of characters allowed for this string is eleven, including a terminating null character. eg, Arabic uses "٠١٢٣٤٥ ٦٧٨٩". See also LOCALE_IDIGITSUBSTITUTION.
    "LOCALE_SNATIVEDISPLAYNAME" 	,0x00000073,	; Win7+: Display name of the locale in its native language, eg, Deutsch (Deutschland) for the locale German (Germany).
    "LOCALE_SNATIVELANGNAME"    	,0x00000004,	; Deprecated for Win7+. Native name of the language. See LOCALE_SNATIVELANGUAGENAME.
    "LOCALE_SNATIVELANGUAGENAME"	,0x00000004,	; Win7+: Native name of the language, eg, Հայերեն for Armenian (Armenia). The maximum number of characters allowed for this string is 80, including a terminating null character.
  )
  , SSORT := Map(
    "LOCALE_SSORTLOCALE"	,0x0000007b,	; Win7+: Name of the locale to use for sorting or casing behavior.
    "LOCALE_SSORTNAME"  	,0x00001013,	; WinMe/98, Win2000: The full localized name of the sort for the specified locale identifier, dependent on the language of the shell. This constant is used to determine casing and sorting behavior
  )
  , STIME := Map(
    "LOCALE_STIME"      	,0x0000001E,	; Character(s) for the time separator. The maximum number of characters allowed for this string is four, including a terminating null character. WinVista+: This constant is deprecated. Use LOCALE_STIMEFORMAT instead. A custom locale might not have a single, uniform separator character. eg, a format such as "03:56'23" is valid.
