...
; Number ⌥⇧
  ; >!+vkC0::	SendInput Bir["1s"][1] 	;[⇧⌥`] vkC0 ⟶ [`] Grave Accent                 	(U+0060) ;DeadKey in Birman Layout
  ; >!+vkC0::	SendInput '{U+0300}'   	;[⇧⌥`] vkC0 ⟶ [ ̀] Combining Grave Accent      	(U+0300) ;DeadKey in Birman Layout
  ...
  ; >!+vk36::	SendInput Bir["1s"][7] 	;[⇧⌥6] vk36 ⟶ [ˆ] Mod Circumflex Accent        	(U+02C6) ;DeadKey in Birman Layout
  ; >!+vk36::	SendInput '{U+0302}'   	;[⇧⌥6] vk36 ⟶ [ ̂̂] Combining Circumflex Accent		(U+0302) ;DeadKey in Birman Layout
...
; Letters: Top Row Q⌥⇧
  ; >!+vk51::	SendInput Bir["Qs"][1] 	;[⇧⌥q] vk51 ⟶ [˘] Breve                   	(U+02D8) ;DeadKey in Birman Layout
  ; >!+vk51::	SendInput '{U+0306}'   	;[⇧⌥q] vk51 ⟶ [ ̆] Combining Breve        		(U+0306) ;DeadKey in Birman Layout
  >!+vk57::  	SendInput Bir["Qs"][2] 	;[⇧⌥w] vk57 ⟶ [⇥] Rightwards Arrow To Bar 	(U+21E5)
  >!+vk45::  	SendInput Bir["Qs"][3] 	;[⇧⌥e] vk45 ⟶ [⇪] Caps Lock               	(U+21EA)
  ; >!+vk52::	SendInput Bir["Qs"][4] 	;[⇧⌥r] vk52 ⟶ [˚] Ring Above              	(U+02DA) ;DeadKey in Birman Layout
  ; >!+vk52::	SendInput '{U+030A}'   	;[⇧⌥r] vk52 ⟶ [ ̊] Combining Ring Above   		(U+030A) ;DeadKey in Birman Layout
...
; Letters: Second Row A⌥⇧
  ...
  ; >!+vk48::	SendInput Bir["As"][6] 	;[⇧⌥h] vk48 ⟶ [⌘] Place of Interest       	(U+2318) ;DeadKey in Birman Layout
  ...
  ; >!+vkBA::	SendInput Bir["As"][10]	;[⇧⌥;] vkBA ⟶ [¨] Diaeresis               	(U+00A8) ;DeadKey in Birman Layout
  ; >!+vkBA::	SendInput '{U+0308}'   	;[⇧⌥;] vkBA ⟶ [ ̈] Combining Diaeresis    		(U+0308) ;DeadKey in Birman Layout
...
; Letters: Third Row Z⌥⇧
  ; >!+vk5A::	SendInput Bir["Zs"][1] 	;[⇧⌥z] vk5A ⟶ [¸] Cedilla                	(U+00B8) ;DeadKey in Birman Layout
  ; >!+vk5A::	SendInput '{U+0327}'   	;[⇧⌥z] vk5A ⟶ [ ̧] Combining Cedilla     	(U+0327) ;DeadKey in Birman Layout
  >!+vk58::  	SendInput Bir["Zs"][2] 	;[⇧⌥x] vk58 ⟶ [✗] Ballot X               	(U+2717)
  >!+vk43::  	SendInput Bir["Zs"][3] 	;[⇧⌥c] vk43 ⟶ [¢] Cent                   	(U+00A2)
  ; >!+vk56::	SendInput Bir["Zs"][4] 	;[⇧⌥v] vk56 ⟶ [ˇ] Caron                  	(U+02C7) ;DeadKey in Birman Layout, acts as Combining
  ; >!+vk56::	SendInput '{U+030C}'   	;[⇧⌥v] vk56 ⟶ [ ̌] Combining Caron       	(U+030C) ;DeadKey in Birman Layout
  >!+vk42::  	SendInput Bir["Zs"][5] 	;[⇧⌥b] vk42 ⟶ [ẞ] LatCap Sharp S         	(U+1E9E)
  ; >!+vk4E::	SendInput Bir["Zs"][6] 	;[⇧⌥n] vk4E ⟶ [˜] Small Tilde            	(U+02DC) ;DeadKey in Birman Layout
  ; >!+vk4E::	SendInput '{U+0303}'   	;[⇧⌥n] vk4E ⟶ [ ̃] Combining Tilde       	(U+0303) ;DeadKey in Birman Layout
  ...
  ; >!+vkBF::	SendInput Bir["Zs"][10]	;[⇧⌥/] vkBF ⟶ [´] Acute Accent           	(U+00B4) ;DeadKey in Birman Layout
  ; >!+vkBF::	SendInput '{U+0301}'   	;[⇧⌥/] vkBF ⟶ [ ́] Combining Acute Accent	(U+0301) ;DeadKey in Birman Layout
}
